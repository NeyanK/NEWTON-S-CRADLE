...
function setup() 
{
  ...
  bob1 = Bodies.circle(300, 500, 10,  bob_options);
  World.add(world,bob1);
  
  bob2 = Bodies.circle(350, 500, 50, bob_options);
  World.add(world,bob2);
 
  bob3 = Bodies.circle(400, 500, 50, bob_options);
  World.add(world,bob3);
  
  bob4 = Bodies.circle(450, 500, 50, bob_options);
  World.add(world,bob4);
  
  bob5 = Bodies.circle(500, 500, 50, bob_options);
...
function keyPressed() {
	if(keyCode === UP_ARROW)
	 {
		Matter.Body.applyForce(bob1,bob1.position,{x:-52,y:-45});
	}
